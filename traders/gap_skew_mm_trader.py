...
class Trader:
    ...
    def mm_strategy(self, state: TradingState, key):
        ...
        result.append(Order(key, bid_price, min(max_allowed_bid_position, 100)))
        result.append(Order(key, ask_price, max(max_allowed_ask_position, -100)))
